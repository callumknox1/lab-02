...
author: "Group Members: Callum Knox, Qian Zheng, Bill Xu and Tonylouis Verberi"
...
staff_long %>%
  ggplot(aes(x = years, y = number_of_people, color = faculty_type , group = faculty_type ) ) +
  geom_line()
```
